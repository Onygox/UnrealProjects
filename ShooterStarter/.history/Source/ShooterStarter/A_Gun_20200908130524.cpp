...
bool AA_Gun::GunTrace(FHitResult& Hit, FVector& ShotDirection) 
{
	...
	FRotator OwnerRotation;// DrawDebugPoint(GetWorld(), Hit.Location, 20, FColor::Red, true);
	...
	bool bSuccess = GetWorld()->LineTraceSingleByChannel(Hit, OwnerLocation, End, ECollisionChannel::ECC_GameTraceChannel1, Params);
}
